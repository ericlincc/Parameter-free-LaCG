...
# lp_solver_cvxopt = ConstrainedL1BallPolytope(
#     l1_regularization,
#     dimension,
...
# print("cvxopt time ", time.time() - ref_time)
ref_time = time.time()
...
print(
    ...
    np.all(inequality_matrix.dot(sol_lp_solver_scipy) <= inequality_vector),
    # np.all(inequality_matrix.dot(sol_lp_solver_cvxopt) <= inequality_vector),
)
print("scipy solution ", sol_lp_solver_scipy)
# print("cvxopt solution ", sol_lp_solver_cvxopt)
print("l1 solution ", sol_l1_ball)
# print(
#     "Difference between cvxopt and scipy solution ",
#     np.linalg.norm(sol_lp_solver_scipy - sol_lp_solver_cvxopt),
# )
print(
    "Difference between l1 and scipy solution ",
    np.linalg.norm(sol_l1_ball - sol_lp_solver_scipy),
)
# print(
#     "Are the two solutions close enough? ",
#     np.allclose(sol_lp_solver_scipy, sol_lp_solver_cvxopt),
# )

quit()

print("\n General setup")
lp_solver_general_scipy = GeneralPolytope(
    dimension,
    const_matrix_ineq=inequality_matrix,
    const_vector_ineq=inequality_vector,
    solver_type="scipy",
...
lp_solver_general_cvxopt = GeneralPolytope(
    dimension,
    const_matrix_ineq=inequality_matrix,
    const_vector_ineq=inequality_vector,
    solver_type="cvxopt",
