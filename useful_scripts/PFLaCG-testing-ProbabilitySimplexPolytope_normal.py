...
cond_num = int(objective_function.L/objective_function.Mu)
...
#        f"-Natural-dim_{dimension}-cond_{cond_num}-seed_{seed_value}.pickle",
#    ),
#    "wb"
#) as f:
...
AFW_algorithm = FrankWolfeSimplex("AFW", "line_search")
...
PFLaCG = ParameterFreeLaCGSimplex(iter_sync=ITER_SYNC)
...
PFW_algorithm = FrankWolfeSimplex("PFW", "line_search")
